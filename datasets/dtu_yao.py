...
class MVSDataset(Dataset):
    def __init__(self, datapath, listfile, mode, nviews, 
        ...
        self.max_src_views= geo_mask_sum_thresh
        self.kwargs = kwargs
    ...
    def __getitem__(self, idx):
        ...
        view_ids = [ref_view] + src_views[:int(self.max_src_views)]
        ...
        for i, vid in enumerate(view_ids):
            ...
            if i == 0:  # reference view
                ...
                # print("min-max",np.min(depth_values), np.max(depth_values))
