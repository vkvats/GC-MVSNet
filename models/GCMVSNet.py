...
from .module import *
from .loss import *
from .feature_nets import * 
from .costreg_net import *
...
class PixelwiseNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv0 = ConvBnReLU3D(in_channels=1, out_channels=8, kernel_size=1, stride=1, pad=0)
        self.conv1 = ConvBnReLU3D(in_channels=8, out_channels=16, kernel_size=1, stride=1, pad=0)
        self.conv2 = ConvBnReLU3D(in_channels=16, out_channels=8, kernel_size=1, stride=1, pad=0)
        self.conv3 = nn.Conv3d(in_channels=8, out_channels=1, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, x1):
        ...
        x1 = self.conv3(self.conv2(self.conv1(self.conv0(x1)))).squeeze(1) # [B, D, H, W]
...
class GCMVSNet(nn.Module):
    def __init__(self, refine=False, ndepths=[48, 32, 8], depth_interals_ratio=[4, 2, 1], share_cr=False,
        ...
        self.feature = DeformableFeatureNet(base_channels=8)
